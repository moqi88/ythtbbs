...
do_ccc(struct fileheader *x, struct boardmem *brd1, struct boardmem *brd)
{
	...
	printf("<a href=bbsdoc?B=%d>返回 %s (%s) 讨论区.</a><br>\n",getbnumx(brd1),brd1->header.title,board);
	printf("<a href=bbsdoc?B=%d>前往 %s (%s) 讨论区.</a><br>\n",getbnumx(brd),brd->header.title,board2);
