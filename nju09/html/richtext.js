...
function writeRTE(rte, html, width, height, buttons, readOnly) {
	...
	document.writeln("<table width=100% height=100%><tr height=70><td>");
...
document.writeln('<td><img class="rteImage" src="' + imagesPath + 'bold.gif" width="25" height="24" alt="Bold" title="Bold" onClick="FormatText(\'' + rte + '\', \'bold\', \'\')"></td>'
	...
	document.writeln('<iframe width="100%" height="40" src="/smilies/smilies.html" marginwidth="0" marginheight="0" scrolling="no"></iframe>');
	document.writeln("</td></tr><tr><td>");
	document.writeln('<iframe id="' + rte + '" name="' + rte + '" width=100% height=100%></iframe>');
	if (!readOnly) document.writeln('</td></tr><tr height=20><td><input type="checkbox" id="chkSrc' + rte + '" onclick="toggleHTMLSrc(\'' + rte + '\');" />&nbsp;View Source</td></tr></table>');
...
function enableDesignMode(rte, html, readOnly) {
	...
	if(false) {
		...
		frameHtml += "<style>body {background: #FFFFFF;margin: 10px;padding: 0px;}\n"
