...
<div id="metanav" class="nav">
 ...
 <ul>
  <li class="first"><?cs if:trac.authname == "anonymous" || !trac.authname ?>
    <a href="<?cs var:trac.href.login ?>">登录</a>
  <?cs else ?>
    logged in as <?cs var:trac.authname ?> </li>
    <li><a href="<?cs var:trac.href.logout ?>">注销</a>
  <?cs /if ?></li>
  <li><a href="<?cs var:trac.href.settings ?>">设置</a></li>
  <li><a accesskey="6" href="<?cs var:trac.href.wiki ?>/TracGuide">帮助</a></li>
  ...
  <li class="last"><a accesskey="9" href="<?cs var:trac.href.about ?>">关于 Trac</a></li>
 </ul>
</div>
...
<div id="mainnav" class="nav">
 <ul>
  ...
  <?cs call:navlink("日志", $trac.href.timeline, "timeline",
  ...
  <?cs call:navlink("查看问题", $trac.href.report, $ticket_view,
                    $trac.acl.REPORT_VIEW, "") ?>
  <?cs call:navlink("报告问题", $trac.href.newticket, "newticket",
                    $trac.acl.TICKET_CREATE, "7") ?>
  <?cs call:navlink("搜索", $trac.href.search, "search",
