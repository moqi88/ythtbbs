...
print_gophertitle()
{
	...
	prints
	    ("             \033[1;32mF \033[37m寄回自己的信箱 \033[32m ↑↓\033[37m 移动  \033[32m→ <Enter>\033[37m 读取 \033[32m ←\033[37m 离开");
}
...
show_gopher()
{
	...
	for (i = page; i < page + 19 && i < range; i++) {
		...
		prints(" %4d [\033[1m%9s\033[m] %-65s\n", i + 1,
		       ((tmpnode->title[0] == '0') ? "\033[32m连文" :
			"\033[33m连目"), tmpnode->title + 1);
	}
	return 0;
}
