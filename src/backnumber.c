...
selectbacknumbertitle()
{
	...
	if (chkmail())
		showtitle("选择过刊", "[您有信件,请按 w 查看信件]");
	else
		showtitle("选择过刊", MY_BBS_NAME);
	prints
	    ("离开[\033[1;32m←\033[m,\033[1;32me\033[m]  选择[\033[1;32m↑\033[m,\033[1;32m↓\033[m]  阅读[\033[1;32m→\033[m,\033[1;32mRtn\033[m]  开辟新过刊[\033[1;32m^P\033[m]  求助[\033[1;32mh\033[m]\033[m\n");
	prints("\033[1;44m编号 %-12s %6s  %-50s\033[m\n", "版面", "日  期",
	       "标  题");
	clrtobot();
	return 0;
