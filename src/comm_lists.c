...
const struct scommandlist sysconf_cmdlist[] = {
	{"domenu", domenu},
	{"EGroups", (void *) EGroup}, {"BoardsAll", (void *) Boards},
	{"BoardsNew", (void *) New}, {"GoodBrds", (void *) GoodBrds},
	{"LeaveBBS", (void *) Goodbye}, {"Announce", (void *) Announce},
	{"SelectBoard", (void *) Select}, {"ReadBoard", (void *) Read},
	{"SetHelp", (void *) Personal},
	{"Personal", (void *) Personal}, {"DenyLevel",
					  (void *) x_denylevel},
	{"OrdainBM", (void *) m_ordainBM}, {"RetireBM",
					    (void *) m_retireBM},
	{"CheckID", (void *) s_checkid}, {"Hell", (void *) showhell},
	{"Prison", (void *) showprison}, {"Live", (void *) online},
	{"SetAlarm", (void *) setcalltime}, {"MailAll", (void *) mailall},
	{"ExecDict",
	 (void *) x_dict},
	{"LockScreen", (void *) x_lockscreen},
	{"SecondHand", (void *) sec_hand},
	{"WORKER", (void *) x_worker}, {"TT", (void *) x_tt}, {"TETRIS",
							       (void *)
							       x_tetris},
	{"WINMINE", (void *) x_winmine}, {"WINMINE2", (void *) x_winmine2},
	{"RECITE", (void *) x_recite}, {"NCCE", (void *) x_ncce}, {"CHESS",
								   (void *)
								   x_chess},
	{"QKMJ", (void *) x_qkmj},
	{"QUICKCALC", (void *) x_quickcalc},
	{"FREEIP", (void *) x_freeip},
	{"OffLine", (void *) offline}, {"ReadNewMail", (void *) m_new},

	{"ReadMail", (void *) m_read}, {"SendMail", (void *) M_send},
	{"GroupSend", (void *) g_send}, {"OverrideSend", (void *) ov_send}, 
	{"MailSecBM", (void *)mailsecbm}, {"SendNetMail", (void *) m_internet},
	{"BogoMail", (void *) bogomail},
	{"UserDefine", (void *) x_userdefine}, {"CopyKeys",
						(void *) x_copykeys},
	{"DefineKeys", (void *) x_setkeys}, {"DefineKeys2",
					     (void *) x_setkeys2},
	{"DefineKeys3", (void *) x_setkeys3}, {"DefineKeys4",
					       (void *) x_setkeys4},
	{"DefineKeys5", (void *) x_setkeys5}, {"ShowFriends",
					       (void *) t_friends},
	{"ShowLogins", (void *) t_users}, {"QueryUser", t_query},
	{"WaitFriend", (void *) wait_friend}, {"Talk", (void *) t_talk},
	{"SetPager", (void *) t_pager}, {"SetCloak", (void *) x_cloak},
	{"SendMsg", (void *) s_msg}, {"ShowMsg", (void *) show_allmsgs},
	{"SetFriends", (void *) t_friend}, {"SetRejects",
					    (void *) t_reject},
	{"EnterChat", ent_chat},
	{"FillForm", (void *) x_fillform}, {"SetInfo", (void *) x_info},
	{"EditUFiles", (void *) x_edits}, {"ShowLicense",
					   (void *) Conditions},
	{"ShowVersion", (void *) Info}, {"Notepad", (void *) shownotepad},
	{"DoVote", (void *) x_vote},
	...
	{"KickUser", (void *) kick_user}, {"DelUser", (void *) d_user},
	{"OpenVote", (void *) m_vote},
	{"NewBoard", (void *) m_newbrd}, {"EditBoard", (void *) m_editbrd},
	{"DelBoard", (void *) d_board}, {"SetTrace", (void *) m_trace},
//      {"CleanMail", (void *) m_mclean}, 
	{"EditSFiles", (void *) a_edits},
	{"Announceall", (void *) wall}, {"Setsyspass",
					 (void *) setsystempasswd},
	{"FCode", (void *) switch_code},
	{"ADDRESSBOOK", (void *) addressbook}, {"CLEARNEWFLAG",
						(void *) clear_all_new_flag},
	{"ADDPERSONAL", (void *) m_addpersonal},
	{"CancelMail", m_cancel},
	{"MONEYCENTER", (void *) moneycenter},
	{"Friends", (void *) Friends},
	{"KILLER", (void *) killer_main},
	{"FRIENDTEST", (void *) friendshipTest},
...
load_sysconf()
{
	if (dashf("etc/rebuild.sysconf") || !dashf("sysconf.img2")) {
		tracelog("system reload sysconf.img2");
...
/*    if(!USERDEFINE(currentuser, DEF_NORMALSCR))  */
	...
	while (1) {
		...
		case -2:
			...
			break;
		default:
			if (pm->line >= 0 && USERPERM(currentuser, pm->level)) {
				if (pm->line != 0) {
					line = pm->line;
					col = pm->col;
				}
...
char *menu_name;
{
	...
	while (1) {
		printacbar();
		while (pm[now].level < 0
		       || !USERPERM(currentuser, pm[now].level)) {
			now++;
			if (now >= size)
				now = 0;
		}
		...
		case KEY_RIGHT:
			for (i = 0; i < size; i++) {
				if (pos[i].line == pos[now].line
				    ...
				    && USERPERM(currentuser, pm[i].level))
					break;
			}
			if (i < size) {
				now = i;
