...
plot "/home/bbs/reclog/bbsstatproc.log" u 1:2 title "recent 24 hours" with l 1,\
     ...
     "/home/bbs/reclog/bbsstatproc.log" u 1:13 title "average" with l 9,\
     "/home/bbs/reclog/bbsstatproc.log" u 1:16 title "non-mc" with l 6,\
     "/home/bbs/reclog/bbsstatproc.log" u 1:17 title "IP" with l 0
set size 1,0.4
set output "/home/bbs/bbstmpfs/dynamic/netflow.png"
plot "/home/bbs/reclog/bbsstatproc.log" u 1:($14/1024./8.) title "netflow (MBytes/s)" with l 1,\
     "/home/bbs/reclog/bbsstatproc.log" u 1:($15/1024./8.) title "average" with l 2
set terminal png small
set size 1,0.6
