...
main()
{
	...
	printf
	    ("#time\tonline\tonlineavg\ttelnet\ttelnetavg\t"
	     "www\twwwavg\tload\tloadavg\tn162105\taverage\t"
	     "wwwguest\twgavg\tnetflow\tnfavg\tnnonmc\tnip\n");
	for (i = 0; i < 24; i++)
		for (j = 0; j < 10; j++) {
			printf("%d.%d", i, j);
