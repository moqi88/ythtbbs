...
#define SZM_ERR_NONEED  7	//no need
#define SZM_ERR_TOOLARGE  8	//too large
...
int szm_box_any(struct szm_ctx *ctx, void *in, int in_len,
		uint16_t boxsize, void **out, int *out_len);
int szm_head_photo(struct szm_ctx *ctx, void *in, int in_len, 
